...
openRoleMenu=function(){
 ...
 openModal(isHost?'Host Account':'User Account',isHost?'Manage your village and also explore other villages.':'Explore villages, plan trips and discover local experiences.',`<div class="menu-actions">
 <button class="secondary" data-action="profile">👤 My Profile</button>
 <button class="secondary" data-action="my-trips">🗺️ My Trips</button><button class="secondary" data-action="my-bookings">🧳 My Bookings</button>
 ...
 ${isHost?'<button class="secondary" data-action="listing">🏡 My Village Listing</button><button class="secondary" data-action="host-enquiries">📩 Enquiries</button><button class="secondary" data-action="host-bookings">🧳 Bookings</button><button class="secondary" data-action="switch-user">Switch to User</button>':'<button class="secondary" data-action="switch-host">Become a Host</button>'}
