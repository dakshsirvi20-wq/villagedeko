...
function ensureVillageFeedStyles(){
 ...
 @media(max-width:640px){.village-feed-section{padding:42px 18px 58px}.village-feed-body{padding:15px}.village-feed-media,.village-feed-video{aspect-ratio:4/5}.village-feed-body h3{font-size:19px}.village-feed-actions{gap:6px}.village-feed-actions button{padding:8px 11px;font-size:12px}}
