...
function syncSavedListingIntoVillages(){
 ...
 const normalized={...saved,id:'my-listing',ownerUid:firebaseUser?.uid||saved.ownerUid,feedPosts:Array.isArray(saved.feedPosts)?saved.feedPosts:currentFeedPosts};
 if(existingIndex>=0){
