...
function ensureVillageFeedStyles(){
 ...
 @media(max-width:640px){.village-feed-section{padding:38px 14px 54px}.village-feed-body{padding:14px}.village-feed-media,.village-feed-video{aspect-ratio:3/2}.village-feed-body h3{font-size:20px}.village-feed-actions{gap:3px}.village-feed-actions button{width:40px;height:40px}.village-feed-actions svg{width:20px;height:20px}.profile-feed-card{grid-template-columns:1fr}.profile-feed-card img,.profile-feed-card video{width:100%;height:180px}}
