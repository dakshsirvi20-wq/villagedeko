...
function ensureVillageFeedStyles(){
 ...
 .village-feed-section{background:#f7f4ee;padding:64px 6vw 120px;border-bottom:1px solid rgba(0,0,0,.06)}
 .village-feed-head{max-width:1180px;margin:0 auto 24px}.village-feed-list{max-width:760px;margin:0 auto;display:grid;gap:18px;box-sizing:border-box}
