...
async function persistVillageToFirebase(data){
 ...
 data.media={cover:files.cover||existing.media?.cover||null,photos:files.photos||existing.media?.photos||[],videos:files.videos||existing.media?.videos||[]};
...
function listingToVillage(d){
 ...
 return {
  id:'my-listing',name:d.villageName,district:d.district||'',state:d.state||'',cover:'hero-cows.jpg',
