...
function ensureVillageFeedStyles(){
 ...
 .village-feed-village-link{display:inline-flex;align-items:flex-start;gap:6px;border:0;background:transparent;padding:0;color:var(--green);font-size:18px;font-weight:900;line-height:1.3;cursor:pointer;text-align:left;max-width:100%;white-space:normal;overflow-wrap:anywhere}
 .village-feed-village-link:hover{text-decoration:underline}.village-feed-village-link::before{content:'📍';font-size:14px;line-height:1.4;flex:0 0 auto}
 .village-feed-meta strong{display:block;font-size:15px;font-weight:750;margin-top:5px;color:var(--text);line-height:1.35}
