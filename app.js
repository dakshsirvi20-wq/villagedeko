...
function ensureVillageFeedStyles(){
 ...
 .village-feed-section{background:#f7f4ee;padding:56px 6vw 72px;border-bottom:1px solid rgba(0,0,0,.06)}
 .village-feed-head{max-width:1180px;margin:0 auto 22px}.village-feed-list{max-width:780px;margin:0 auto;display:grid;gap:18px}
 ...
 .village-feed-media,.village-feed-video{width:100%;aspect-ratio:4/3;object-fit:cover;display:block;background:#eee;cursor:pointer}.village-feed-video{background:#111;cursor:default}
 .village-feed-media:focus-visible{outline:3px solid var(--green);outline-offset:-3px}
 .village-feed-body{padding:16px 18px 15px}.village-feed-meta{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;margin-bottom:12px}.village-feed-meta-main{min-width:0}
 .village-feed-village-link{display:inline-flex;align-items:center;gap:6px;border:0;background:transparent;padding:0;color:var(--green);font-size:18px;font-weight:900;line-height:1.2;cursor:pointer;text-align:left}
 .village-feed-village-link:hover{text-decoration:underline}.village-feed-village-link::before{content:'📍';font-size:14px}
 .village-feed-meta strong{display:block;font-size:15px;margin-top:5px;color:var(--text)}
 .village-feed-tag{display:block;font-size:10px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;color:#8a6b2f;margin-top:5px}
 .village-feed-delete{margin-left:auto;flex:0 0 auto}
 .village-feed-body h3{margin:14px 0 6px;font-size:23px;line-height:1.18}.village-feed-body p{margin:0;color:#555;line-height:1.55}
 .village-feed-actions{display:flex;align-items:center;gap:5px;margin-top:15px;padding-top:11px;border-top:1px solid rgba(0,0,0,.07)}
 .village-feed-actions button{width:42px;height:42px;border:0;background:transparent;border-radius:12px;padding:0;display:grid;place-items:center;color:#536057;cursor:pointer;transition:background .18s ease,color .18s ease,transform .18s ease}
 .village-feed-actions button:hover{background:#eef1ea;color:var(--green);transform:translateY(-1px)}
 .village-feed-actions button:focus-visible{outline:2px solid var(--green);outline-offset:2px}
 .village-feed-actions button.active{background:#edf2e9;color:var(--green)}
 .village-feed-actions svg{width:21px;height:21px;stroke:currentColor;fill:none;stroke-width:1.9;stroke-linecap:round;stroke-linejoin:round}
 .village-feed-actions .feed-like.active svg{fill:currentColor}.village-feed-actions .feed-save.active svg{fill:currentColor}
 .village-feed-empty{max-width:760px;margin:0 auto}.feed-host-note{padding:12px 14px;border-radius:14px;background:#f3f0e9;margin:12px 0;font-size:13px}
 .vd-feed-form{display:grid;gap:14px}.vd-feed-form .vd-feature-card{padding:14px 16px}.vd-feed-form label{display:grid;gap:7px;font-weight:700;font-size:13px}.vd-feed-form input,.vd-feed-form textarea{width:100%;box-sizing:border-box;border:1px solid rgba(0,0,0,.14);border-radius:12px;padding:11px 12px;background:#fff;font:inherit}.vd-feed-form textarea{resize:vertical;min-height:120px}.vd-feed-form input[type=file]{padding:10px}.vd-feed-form .menu-actions{margin-top:4px}
 .profile-village-feed{margin-top:28px}.profile-feed-card{display:grid;grid-template-columns:180px 1fr;gap:16px;border:1px solid rgba(0,0,0,.08);border-radius:18px;padding:10px;margin:10px 0;background:#fff}.profile-feed-card img,.profile-feed-card video{width:180px;height:125px;object-fit:cover;border-radius:12px;background:#eee}.profile-feed-card small{color:#8a6b2f;font-weight:800;font-size:10px;letter-spacing:.08em}.profile-feed-card h4{margin:7px 0}.profile-feed-card p{margin:0 0 7px;color:#666;line-height:1.5}.profile-feed-card span{font-size:12px;color:#777}
 .vd-feed-image-viewer{display:flex;align-items:center;justify-content:center;width:100%;min-height:55vh;background:#111;border-radius:16px;overflow:hidden}.vd-feed-image-viewer img{display:block;width:100%;height:auto;max-height:78vh;object-fit:contain;background:#111}
 @media(max-width:640px){.village-feed-section{padding:38px 14px 54px}.village-feed-body{padding:14px}.village-feed-media,.village-feed-video{aspect-ratio:4/3}.village-feed-body h3{font-size:20px}.village-feed-actions{gap:3px}.village-feed-actions button{width:40px;height:40px}.village-feed-actions svg{width:20px;height:20px}.profile-feed-card{grid-template-columns:1fr}.profile-feed-card img,.profile-feed-card video{width:100%;height:180px}}
...
function feedIcon(name){
 const icons={
  like:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.8 8.7c0 5.1-8.8 10-8.8 10s-8.8-4.9-8.8-10A4.7 4.7 0 0 1 12 6.2a4.7 4.7 0 0 1 8.8 2.5Z"/></svg>',
  comment:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 11.5a7.5 7.5 0 0 1-7.9 7.5 8.6 8.6 0 0 1-3.1-.6L4 20l1.5-4A7.3 7.3 0 0 1 4.5 12 7.5 7.5 0 0 1 12 4.5a7.5 7.5 0 0 1 8 7Z"/><path d="M8.5 12h.01M12 12h.01M15.5 12h.01"/></svg>',
  save:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6.5 4.5A2.5 2.5 0 0 1 9 2h6a2.5 2.5 0 0 1 2.5 2.5V21L12 17.5 6.5 21Z"/></svg>',
  share:'<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="18" cy="5" r="2.3"/><circle cx="6" cy="12" r="2.3"/><circle cx="18" cy="19" r="2.3"/><path d="m8.1 10.9 7.7-4.5M8.1 13.1l7.7 4.5"/></svg>'
 };
 return icons[name]||'';
}
function renderVillageFeed(){
 ...
 const uid=firebaseUser?.uid||'';const liked=uid?vdUserArray(`villagedeko_feed_likes_${uid}`):[];const saved=vdUserArray('villagedeko_saved_feed_posts').map(x=>x.id);
 root.innerHTML=posts.map(p=>{
  const media=p.media?.url||'';const isVideo=p.media?.resourceType==='video'||String(p.media?.type||'').startsWith('video/');
  const mediaHtml=media?(isVideo?`<video class="village-feed-video" controls playsinline preload="metadata"><source src="${esc(media)}">Your browser does not support video playback.</video>`:`<img class="village-feed-media" src="${esc(media)}" alt="${esc(p.title||'Village update')}" loading="lazy" tabindex="0" data-action="feed-photo" data-photo-url="${esc(media)}" data-photo-alt="${esc(p.title||'Village update')}">`):'';
  const villageId=p.villageId||p.ownerUid||'';
  return `<article class="village-feed-card"><div class="village-feed-body"><div class="village-feed-meta"><div class="village-feed-meta-main"><button class="village-feed-village-link" data-action="feed-village" data-village-id="${esc(villageId)}" aria-label="Open ${esc(p.villageName||'Village')} village profile">${esc(p.villageName||'Village')}</button><strong>${esc(p.authorName||'Village Host')}</strong><span class="village-feed-tag">REAL VILLAGE UPDATE</span></div>${firebaseUser&&p.ownerUid===firebaseUser.uid?`<button class="secondary village-feed-delete" data-action="delete-feed-post" data-post-id="${esc(p.id)}">Delete</button>`:''}</div>${mediaHtml}<h3>${esc(p.title||'Village update')}</h3><p>${esc(p.text||'')}</p><div class="village-feed-actions" aria-label="Village post actions"><button class="feed-like${liked.includes(p.id)?' active':''}" data-action="feed-like" data-post-id="${esc(p.id)}" aria-label="Like" aria-pressed="${liked.includes(p.id)}" title="Like">${feedIcon('like')}</button><button class="feed-comment" data-action="feed-comment" data-post-id="${esc(p.id)}" aria-label="Comment" title="Comment">${feedIcon('comment')}</button><button class="feed-save${saved.includes(p.id)?' active':''}" data-action="feed-save" data-post-id="${esc(p.id)}" aria-label="Save" aria-pressed="${saved.includes(p.id)}" title="Save">${feedIcon('save')}</button><button class="feed-share" data-action="feed-share" data-post-id="${esc(p.id)}" aria-label="Share" title="Share">${feedIcon('share')}</button></div></div></article>`;
 }).join('');
}
function openFeedPhotoViewer(url,alt='Village photo'){
 if(!url)return;
 modalContent.innerHTML=`<h3>Village Photo</h3><div class="vd-feed-image-viewer"><img src="${esc(url)}" alt="${esc(alt)}"></div><button class="primary modal-done-btn" data-action="close">Done</button>`;
 modal.classList.add('show');document.body.classList.add('vd-modal-open');
}
